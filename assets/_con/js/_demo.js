          ...
          for(var n in this.options[k]) {
            ...
            switch(n) {
              case 'Color':
                ...
                if(value == 'blue') {
                  this.styles.setAttribute("href", 'assets/_con/css/con-base.min.css');
                } else {
                  this.styles.setAttribute("href", 'assets/_con/css/con-' + value + '.min.css');
                }
                break;
              ...
              case 'Boxed':
                if(value) {
                  addClass( this.body, 'boxed' );
                } else {
                  removeClass( this.body, 'boxed' );
                }
            }
          }
          break;
  ...
  Layouts.DEFAULT = {
    'layout-boxed': {
      func: function() {
        if(hasClass(demobar.body, 'boxed')) {
          removeClass(demobar.body, 'boxed');
        } else {
          addClass(demobar.body, 'boxed');
        }
      }
    },
    'layout-top-fixed': {
